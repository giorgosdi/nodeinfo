...
sha:
	echo $(shell openssl sha256 < kubectl_nodeinfo_linux_${GOARCH}/kubectl-nodeinfo | awk '{print $$2}')	kubectl_nodeinfo_linux_${GOARCH} > kubectl_nodeinfo_linux_${GOARCH}/kubectl_nodeinfo.sha256
	echo $(shell openssl sha256 < kubectl_nodeinfo_darwin_${GOARCH}/kubectl-nodeinfo | awk '{print $$2}')	kubectl_nodeinfo_darwin_${GOARCH} >> kubectl_nodeinfo_darwin_${GOARCH}/kubectl_nodeinfo.sha256
